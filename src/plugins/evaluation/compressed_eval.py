"""
Compressed Model Evaluation Plugin for Toggle Architecture
...
Specialized for tensor-decomposed models from the Toggle framework.
"""
import time
import torch
import psutil
...
class CompressedToggleAdapter(LM):
    """
    LM Evaluation Harness adapter for compressed Toggle models
